...
public class Studio
{
...

	{
		...
		q.declareVariables("Movie m1, m2; Actor a");
		q.setFilter("this.movies.contains(m1) && m1.releaseYear == yr "
				+ "&& m1.actors.contains(a) && a.movies.contains(m2) && m2.releaseYear == yr" 
				+ "&& m1 != m2"); 
		q.setOrdering("this.name ascending");
